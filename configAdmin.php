    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Panaderia Pacífico</small></h1>
            </div>
            <!-- Nav tabs -->
                        ...
                        <div id="add-product">
                            ...
                            <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control"  placeholder="descripcion del producto" required maxlength="30" name="prod-model">
                              </div>
                              <div class="form-group">
                                <label>Marca</label>
                                <input type="text" class="form-control"  placeholder="marca del producto" required maxlength="30" name="prod-marca">
                              </div>
                              <div class="form-group">
                                <label>Stock</label>
                                <input type="text" class="form-control"  placeholder="cantidad en stock" required maxlength="20" pattern="[0-9]{1,20}" name="prod-stock">
                              </div>
                              <div class="form-group">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="process/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="prove-nit" placeholder="Codigo proveedor" maxlength="30" required="">
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
